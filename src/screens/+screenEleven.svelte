...
>
  ...
  >
    <p>Thank you for completing the rating task. We have a few more questions.</p>
<!-- centered div -->
    <div class="center-div flex flex-col justify-center items-center gap-4">
    <h2 class="flex-wrap text-center font-bold"> Please briefly summarize the story you just heard in a couple of sentence:</h2>
    <!-- textarea -->
    <textarea name="story" id="story" cols="50" rows="3" class="border border-black text-sm px-1"></textarea>
    </div>

    <!-- last div or container -->
    <div class="last flex flex-col justify-center items-center gap-4">
        <h2 class="font-bold">What was the dominant emotion you experienced while listening to the story:</h2>
        <!-- input filed -->
         <input
        type="text"
